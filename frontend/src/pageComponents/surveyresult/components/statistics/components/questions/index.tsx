'use client'
import {
    Survey_Container, Survey_Title_Container, SurveyQuestionContainer, SurveyQuestion, Surveycontent
    , StyledTag
} from '@/pageComponents/surveyAnswer/components/question/Question.styled'
