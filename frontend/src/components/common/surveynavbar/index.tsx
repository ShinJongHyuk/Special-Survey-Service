...
import useSelectedStore from "@/stores/makesurvey/useSelectedStore";
...
import {Right_Button_Box,StyleLogout,StyledProfileName,StyledPropfileLink,OptionBox,Buttons,Button_Box,Title_Label,Title_Content,Title_Container,Navbar_Container,Top_Container,Bottom_Container } from './SurveyNavbar.styled';
